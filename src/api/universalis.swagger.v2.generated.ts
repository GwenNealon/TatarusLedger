        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            [key: string]: components["schemas"]["Universalis.Application.Views.V1.Extra.Stats.WorldUploadCountView"];
                        };
                        "text/json": {
                            [key: string]: components["schemas"]["Universalis.Application.Views.V1.Extra.Stats.WorldUploadCountView"];
                        };
...
export interface components {
    schemas: {
        ...
        "Universalis.Application.Views.V1.CurrentlyShownView": {
            ...
            listings?: components["schemas"]["Universalis.Application.Views.V1.ListingView"][] | null;
            /**
             * Format: int32
            ...
            recentHistory?: components["schemas"]["Universalis.Application.Views.V1.SaleView"][] | null;
            /**
             * Format: int32
        ...
        "Universalis.Application.Views.V1.Extra.Stats.MostRecentlyUpdatedItemsView": {
            ...
            items?: components["schemas"]["Universalis.Application.Views.V1.Extra.Stats.WorldItemRecencyView"][] | null;
        };
        ...
        "Universalis.Application.Views.V1.HistoryView": {
            ...
            entries?: components["schemas"]["Universalis.Application.Views.V1.MinimizedSaleView"][] | null;
            /**
             * Format: float
             * @description The average number of HQ sales per day, over the past seven days (or the entirety of the shown sales, whichever comes first).
             */
        ...
        "Universalis.Application.Views.V1.ListingView": {
            ...
            materia?: components["schemas"]["Universalis.Application.Views.V1.MateriaView"][] | null;
        ...
        "Universalis.Application.Views.V2.AggregatedMarketBoardData": {
            ...
            results?: components["schemas"]["Universalis.Application.Views.V2.AggregatedMarketBoardData.Result"][] | null;
        };
        ...
        "Universalis.Application.Views.V2.AggregatedMarketBoardData.Result": {
            ...
            worldUploadTimes?: components["schemas"]["Universalis.Application.Views.V2.AggregatedMarketBoardData.WorldUploadTime"][] | null;
        };
        ...
        "Universalis.Application.Views.V2.CurrentlyShownMultiViewV2": {
            ...
            items?: {
                [key: string]: components["schemas"]["Universalis.Application.Views.V1.CurrentlyShownView"];
            } | null;
        ...
        "Universalis.Application.Views.V2.HistoryMultiViewV2": {
            ...
            /** @description The item data that was requested, keyed on the item ID. */
            items?: {
                [key: string]: components["schemas"]["Universalis.Application.Views.V1.HistoryView"];
            } | null;
            /** @description The name of the region requested, if applicable. */
            regionName?: string | null;
            /** @description A list of IDs that could not be resolved to any item data. */
